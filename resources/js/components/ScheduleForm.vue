    ...
    <div class="max-w-2xl mx-auto p-6">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div>
                <div class="mt-1 mb-1">
                    <button
                        class="w-md bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 cursor-pointer"
                        type="button"
                        @click="addVisitor">
                        Add Another Visitor
                    </button>
